          ...
          <div className="bg-white rounded-lg border border-blue-200 p-4">
            <div className="flex items-center justify-between">
              <code className="text-sm font-mono text-gray-800 bg-gray-100 px-3 py-2 rounded flex-1 mr-3">
                https://threatresponse.ndbbank.com/api/edl/{categoryName || categoryObj?.name || category}
              </code>
              <button
                onClick={() => navigator.clipboard.writeText(`https://threatresponse.ndbbank.com/api/edl/${categoryName || categoryObj?.name || category}`)}
